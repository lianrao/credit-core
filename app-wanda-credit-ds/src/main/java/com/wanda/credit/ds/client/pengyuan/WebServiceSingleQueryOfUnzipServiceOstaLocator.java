...
public class WebServiceSingleQueryOfUnzipServiceOstaLocator extends org.apache.axis.client.Service implements WebServiceSingleQueryOfUnzipService {

	private static final long serialVersionUID = -2210064795929528507L;

	public WebServiceSingleQueryOfUnzipServiceOstaLocator() {
    }


    public WebServiceSingleQueryOfUnzipServiceOstaLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public WebServiceSingleQueryOfUnzipServiceOstaLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    
    // Use to get a proxy class for WebServiceSingleQueryOfUnzip
    private java.lang.String WebServiceSingleQueryOfUnzip_address = DynamicConfigLoader.get("sys.credit.client.pengyuan.osta.url");
