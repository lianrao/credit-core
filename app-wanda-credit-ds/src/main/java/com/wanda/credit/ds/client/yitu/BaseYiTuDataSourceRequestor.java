...
public class BaseYiTuDataSourceRequestor extends BaseDataSourceRequestor{
	...
	protected final String STATUS_YITU_NO1 = "01";
	protected final String STATUS_YITU_NO2 = "02";
	protected final String STATUS_YITU_NO3 = "03";
	/**
	 * 初始化连接资源
	...
	public static void init() throws PublicKeyException{
		if(pk==null){
			pk = EncryptionHelper.RSAHelper
					.loadPublicKey(BaseYiTuDataSourceRequestor.class
							.getClassLoader()
