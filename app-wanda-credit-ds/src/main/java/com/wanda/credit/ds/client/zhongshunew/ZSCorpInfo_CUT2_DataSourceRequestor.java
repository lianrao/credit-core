 ...
 * add by wj 20180705*/
@DataSourceClass(bindingDataSourceId="ds_zsCorpQuery_cut2")
public class ZSCorpInfo_CUT2_DataSourceRequestor extends BaseZS_NEW_DataSourceRequestor
		implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(ZSCorpInfo_CUT2_DataSourceRequestor.class);
		...
		try{
	      ...
	      //保存企业详情到数据库
	        ...
	        if("200".equals(json.getString("CODE"))){
				...
				rets.put(Conts.KEY_RET_MSG, "未查询到记录");		
	        }	
		} catch (Exception ex) {
