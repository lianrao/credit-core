 ...
 */
@Entity
@Table(name = "CPDB_DS.T_DS_JXL_REP_BEHAVIOR_CHECK")
@JsonIgnoreProperties(value = { "hibernateLazyInitializer"})
@JsonSerialize(include = JsonSerialize.Inclusion.NON_NULL)
public class BehaviorCheckPojo extends BaseDomain{
	...
	public String getCheck_point_en() {
		return check_point_en;
	}
	public void setCheck_point_en(String check_point_en) {
		this.check_point_en = check_point_en;
	}
