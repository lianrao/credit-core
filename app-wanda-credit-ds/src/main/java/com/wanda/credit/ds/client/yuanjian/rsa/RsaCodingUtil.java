...
public final class RsaCodingUtil {
	 ...
	 * @return hex串
	 */
	public static String encryptByPubCerText(String src, String pubKeyText,String pubCerPath) {
		PublicKey publicKey = RsaReadUtil.getPublicKeyFromFile(pubCerPath);
		if (publicKey == null) {
			return null;
		}
	...
	public static String decryptByPriPfxFile(String src) {
		...
		PrivateKey privateKey = BaseYuanJSourceRequestor.yj_privatekey;
		if (privateKey == null) {
			return null;
		}
