 ...
 *
 */
@DataSourceClass(bindingDataSourceId="ds_dmp_mobileStatus")
public class DMPJiAoMobileStatusDSRequestor extends BaseDMPJiAoDSRequestor implements
		IDataSourceRequestor {
	
	private Logger logger = LoggerFactory.getLogger(DMPJiAoMobileStatusDSRequestor.class);
	...
	public Map<String, Object> request(String trade_id, DataSource ds) {
		...
		url = propertyEngine.readById("ds_dmp_status_url");
//		url = "http://10.213.128.91/gateway8000/data/geoQueryUnify/A4";
		
		final String prefix = trade_id + " " + Conts.KEY_SYS_AGENT_HEADER;
		long start = System.currentTimeMillis();
		logger.info("{} 手机号码状态查询-网数-集奥Begin {}" , prefix ,start);
		...
		logger.info("{} 手机状态查询End，交易时间为(ms):{}",prefix ,(System.currentTimeMillis() - start));
		return rets;
