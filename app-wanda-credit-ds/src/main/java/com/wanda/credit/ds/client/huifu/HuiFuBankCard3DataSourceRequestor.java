...
@DataSourceClass(bindingDataSourceId="ds_huifu_bank3")
public class HuiFuBankCard3DataSourceRequestor extends BaseHuifuDSRequestor
implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(HuiFuBankCard3DataSourceRequestor.class);
	@Autowired
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		try{
			...
			JSONObject result = getBankResult(trade_id,request_url,callback_url,app_token,appkey,
					name,cardNo,cardId,"",5000,huifu_times);
