...
public class SSLProtocolSocketFactory implements ProtocolSocketFactory
{
            ...
            HttpConnectionParams params) throws IOException, UnknownHostException, ConnectTimeoutException
    {
        ...
        SocketFactory socketFactory = SSLContextFactoryk.getInstance(this.isChkCert).getSocketFactory();
        if (timeout == 0)
        {
    ...
    {
        return SSLContextFactoryk.getInstance(this.isChkCert).getSocketFactory().createSocket(host, port, localAddress,
                localPort);
    }
    ...
    {
        return SSLContextFactoryk.getInstance(this.isChkCert).getSocketFactory().createSocket(host, port);
    }
}