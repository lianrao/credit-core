...
/**
 * author:nan.liu
 * desc:依图人脸识别100.1登记接口
 * data:2017-06-21
 * version:1.0
 * */
@DataSourceClass(bindingDataSourceId="ds_yitu_dj100")
public class YiTuPhotoRegisterRequestor extends BaseYiTuNewSourceRequestor
		implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(YiTuPhotoRegisterRequestor.class);
	private String registerImgApi;
	private String yitu_saas_address; 
	private String accessId; 
	private String accessKey; 
	
	private final String INTERFACE_TYPE = "100";
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		try{
			...
			if(!inCached){
				...
				params.put("mode", 1);
				param_user_info.put("image_content", photo);
				param_option.put("image_type", (int)Double.parseDouble(ptype));	
				...
				String res = RequestHelper.doPost(yitu_url + registerImgApi, null, headers,
	...
	public String getRegisterImgApi() {
		return registerImgApi;
	}

	public void setRegisterImgApi(String registerImgApi) {
		this.registerImgApi = registerImgApi;
	}
}
