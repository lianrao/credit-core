...
@DataSourceClass(bindingDataSourceId="ds_jixin_AuthenBankCard4")
public class JiXinAuthenBankCard4DataSourceRequestor extends BaseDataSourceRequestor
implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(JiXinAuthenBankCard4DataSourceRequestor.class);
...
//			logObj.setReq_url("http://121.201.18.232/jxdata/api/auth/execute.do");
			logObj.setState_code(DataSourceLogEngineUtil.TRADE_STATE_FAIL);
	 		String transCode =  "107"; //交易码
			...
			setBusiReqData(trade_id,reqdata,name,cardNo,cardId,phone);
            ...
            if(!StringUtils.isEmpty(response)){
                ...
                if ("1".equals(isEnc)) {
                    ...
                    encPhone = GladDESUtils.encrypt(phone);
                }
                ...
                allAuthCardService.saveJXAuthCard(ds.getId(), trade_id,
                        name, encCardNo, encCardId, encPhone, retdata, req_values);
