...
@Entity
@Table(name = "T_DS_GUOZT_MULT_RESULT",schema="CPDB_DS")
@JsonIgnoreProperties(value = { "hibernateLazyInitializer"})
@JsonSerialize(include = JsonSerialize.Inclusion.NON_NULL)
public class Guozt_Mult_Check_Result extends BaseDomain{
	/**
	 */
	...
	public String getWybs_number() {
		return wybs_number;
	}
	public void setWybs_number(String wybs_number) {
		this.wybs_number = wybs_number;
	}
