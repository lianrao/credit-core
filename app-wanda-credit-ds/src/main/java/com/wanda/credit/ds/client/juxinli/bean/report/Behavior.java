...
public class Behavior {
	...
	public String toString() {
		return "Behavior [sms_cnt=" + sms_cnt + ", cell_phone_num="
				+ cell_phone_num + ", net_flow=" + net_flow + ", total_amount="
				+ total_amount + ", call_out_time=" + call_out_time
				+ ", cell_mth=" + cell_mth + ", cell_loc=" + cell_loc
				+ ", call_cnt=" + call_cnt + ", cell_operator_zh="
				+ cell_operator_zh + ", call_out_cnt=" + call_out_cnt
				+ ", cell_operator=" + cell_operator + ", call_in_time="
