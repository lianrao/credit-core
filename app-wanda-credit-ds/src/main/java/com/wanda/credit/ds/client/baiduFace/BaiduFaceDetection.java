 ...
 */
@DataSourceClass(bindingDataSourceId="ds_baidu_face")
public class BaiduFaceDetection extends BaseBaiduFaceRequestor implements IDataSourceRequestor {
    private Logger logger = LoggerFactory.getLogger(BaiduFaceDetection.class);
    @Autowired
