...
@Service
@Transactional
public class YidaoBankServiceImpl  extends BaseServiceImpl<Yidao_bank_result> implements IYidaoBankService{
	private final  Logger logger = LoggerFactory.getLogger(YidaoBankServiceImpl.class);

	@Override
	public void batchSave(List<Yidao_bank_result> result) {
		try {
			this.add(result);
