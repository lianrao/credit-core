...
@DataSourceClass(bindingDataSourceId="ds_nciic_jx")
public class NciicDataSourceRequestor extends BaseNciicDataSourceRequestor
		implements IDataSourceRequestor {
	private Logger logger = LoggerFactory.getLogger(NciicDataSourceRequestor.class);
