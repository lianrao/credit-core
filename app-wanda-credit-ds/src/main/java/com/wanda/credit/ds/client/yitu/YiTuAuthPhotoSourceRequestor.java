...
@DataSourceClass(bindingDataSourceId="ds_yitu_onlyPhoto")
public class YiTuAuthPhotoSourceRequestor extends BaseYiTuDataSourceRequestor implements IDataSourceRequestor {
	private final Logger logger = LoggerFactory.getLogger(YiTuAuthPhotoSourceRequestor.class);
	private final String PHOTO_SIZE_FAIL = "YTBD_003";
	private final String MSG_SUCC = "交易成功";
	private String verifImgApi;
	private String yitu_saas_address;
	private String accessId;
	private String accessKey;
	private String true_negative_rate;// add by wangjing 2015-11-27 
	...
	public Map<String, Object> request(String trade_id, DataSource ds) {
		...
		logObj.setDs_id("ds_yitu_onlyPhoto");//log:供应商id
		...
		try {
			...
			if(formatStrSize(photoContent)){
				logObj.setBiz_code1(PHOTO_SIZE_FAIL);
				rets.clear();
				...
				ytAuth.setName(name);
				ytAuth.setPhoto_id(photo);
				ytAuth.setStatus(STATUS_YITU_NO3);
				ytAuth.setTrans_type(transType);
				Map<String, Object> respMap = null;
				Map<String, Object> params = new TreeMap<String, Object>();
				Map<String, String> headers = new TreeMap<String, String>();
				params.put("user_id", sendCard); // 加密身份证号码,避免被泄露
				params.put("query_image_content", photoContent);
