 ...
 *
 */
public class BaseBairongDSRequestor extends BaseDataSourceRequestor {
	
	private Logger logger = LoggerFactory.getLogger(BaseBairongDSRequestor.class);
    ...
    public Map<String, String> getTimeResMap(){
        if (inTimeMap == null) {
            ...
            inTimeMap.put("0-3", "0");
            inTimeMap.put("3-6", "1");
            inTimeMap.put("6-12", "2");
            inTimeMap.put("12-18", "3");
            inTimeMap.put("18-24", "3");
            inTimeMap.put(">24", "4");
        }
        return inTimeMap;
    }
