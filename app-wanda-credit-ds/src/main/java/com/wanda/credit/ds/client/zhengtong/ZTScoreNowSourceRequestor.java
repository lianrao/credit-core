...
@DataSourceClass(bindingDataSourceId="ds_zhengtong_pf")
public class ZTScoreNowSourceRequestor extends BaseZTDataSourceRequestor
		implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(ZTScoreNowSourceRequestor.class);
