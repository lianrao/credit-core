...
@DataSourceClass(bindingDataSourceId="ds_nciic_noPhotojx")
public class NciicNoPhotoDataSourceRequestor extends BaseNciicDataSourceRequestor
		implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(NciicNoPhotoDataSourceRequestor.class);
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		try{
			...
			logObj.setDs_id("ds_nciic_noPhotojx");
			...
			if(!nciicCheckService.inCachedCount(name, enCardNo,incache_days)){
				...
				if(errorCode!=null){
					...
					if(errorMesg!=null){
						...
						}else if(CHECK_NOEQUAL.equals(name_check)){
