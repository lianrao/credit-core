...
@DataSourceClass(bindingDataSourceId="ds_yitu_dj")
public class YiTuRegisteDataSourceRequestor extends BaseYiTuDataSourceRequestor
		implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(YiTuRegisteDataSourceRequestor.class);
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		logObj.setDs_id("ds_yitu_dj");//log:供应商id
		...
		try{
			...
			if(!inCached){
				...
				params.put("database_image_content", photo);
