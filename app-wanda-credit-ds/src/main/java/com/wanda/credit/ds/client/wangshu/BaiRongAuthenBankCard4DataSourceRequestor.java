...
@DataSourceClass(bindingDataSourceId="ds_bairong_AuthenBankCard4")
public class BaiRongAuthenBankCard4DataSourceRequestor extends BaseBaiRongAuthenBankCardDataSourceRequestor
implements IDataSourceRequestor {
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		try{			
			...
			logObj.setReq_url(propertyEngine.readById("wdwsh_brauthcard4url"));
			...
			if(isSuccess(rspData)){
				bairongAuthCardService.saveAuthCard4(trade_id,
	...
	public String buildRequestUrl(String trade_id, String name, String cardNo,
		...
		String url = propertyEngine.readById("wdwsh_brauthcard4url");
		StringBuilder sb = new StringBuilder();
		sb.append(url).append("?");		
		sb.append("id=").append(cardNo).append("&name=").append(name).
		append("&cell=").append(phone).append("&bank_id=").append(cardId);		
		return sb.toString();
	}
	...
	protected String buildTag(String trade_id, JSONObject rspData) {
		...
		if(flag != null && flag.get("flag_bankfourpro") != null && 
				"1".equals(flag.get("flag_bankfourpro").toString())){
