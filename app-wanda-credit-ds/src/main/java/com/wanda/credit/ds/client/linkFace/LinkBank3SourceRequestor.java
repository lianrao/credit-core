 ...
 * 描述: 银行卡三要素验证
 */
@DataSourceClass(bindingDataSourceId = "ds_linkface_bank3")
public class LinkBank3SourceRequestor extends BaseLinkFaceRequestor
		implements IDataSourceRequestor {
	private final Logger logger = LoggerFactory.getLogger(LinkBank3SourceRequestor.class);
	@Autowired
