...
@DataSourceClass(bindingDataSourceId="ds_xiaohe_police")
public class XiaoHePoliceRequestor extends BasePSGDataSourceRequestor implements IDataSourceRequestor {
	private Logger logger = LoggerFactory.getLogger(XiaoHePoliceRequestor.class);
