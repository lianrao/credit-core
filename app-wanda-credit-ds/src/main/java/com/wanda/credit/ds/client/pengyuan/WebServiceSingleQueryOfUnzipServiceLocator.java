...
public class WebServiceSingleQueryOfUnzipServiceLocator extends org.apache.axis.client.Service implements WebServiceSingleQueryOfUnzipService {

    public WebServiceSingleQueryOfUnzipServiceLocator() {
    }


    public WebServiceSingleQueryOfUnzipServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public WebServiceSingleQueryOfUnzipServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    
    // Use to get a proxy class for WebServiceSingleQueryOfUnzip
    private java.lang.String WebServiceSingleQueryOfUnzip_address = DynamicConfigLoader.get("sys.credit.client.pengyuan.url");
    ...
    public WebServiceSingleQueryOfUnzip_PortType getWebServiceSingleQueryOfUnzip(String url) throws javax.xml.rpc.ServiceException {
        java.net.URL endpoint;
         try {
