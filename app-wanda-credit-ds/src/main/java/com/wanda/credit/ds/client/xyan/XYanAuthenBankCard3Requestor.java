 ...
 * 
 */
@DataSourceClass(bindingDataSourceId = "ds_xyan_bank3")
public class XYanAuthenBankCard3Requestor extends
		BaseXYanAuthenBankCardDataSourceRequestor implements
		IDataSourceRequestor {
	private final Logger logger = LoggerFactory
			.getLogger(XYanAuthenBankCard3Requestor.class);
	@Autowired
	...
	public Map<String, Object> request(String trade_id, DataSource ds) {
		...
		try {
			...
			po.put("verify_element", "123");// ds入参 必填 校验类型 2、3、4要素
