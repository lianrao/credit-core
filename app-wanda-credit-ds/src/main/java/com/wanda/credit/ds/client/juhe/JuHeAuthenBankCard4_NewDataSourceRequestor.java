...
@DataSourceClass(bindingDataSourceId="ds_juhe_AuthenBankCard4_new")
public class JuHeAuthenBankCard4_NewDataSourceRequestor extends BaseJuheDSRequestor
implements IDataSourceRequestor {
	private final  Logger logger = LoggerFactory.getLogger(JuHeAuthenBankCard4_NewDataSourceRequestor.class);
	...
	public Map<String, Object> request(String trade_id, DataSource ds){
		...
		try{
			String url = propertyEngine.readById("ds_juhe_verifybankcard4_url");
            ...
            reqparam.put("key", propertyEngine.readById("ds_juhe_verifybankcard4_key"));
			...
			if(isSuccess(rspData)){
				...
				allAuthCardService.savaJuHeAuthCard(ds.getId(), trade_id, name,
						encCardNo, encCardId, encPhone, result, req_values);
...
//	public String buildRequestUrl(String trade_id, String url, String name, String cardNo,
